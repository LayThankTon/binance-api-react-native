...
var privateCall = function privateCall(_ref3) {
  ...
  return function (path) {
    ...
    return (data && data.useServerTime ? pubCall('/api/v3/time').then(function (r) {
      ...
      var signature = _cryptoJs.default.algo.HMAC.create(_cryptoJs.default.algo.SHA256, apiSecret).update(makeQueryString(_objectSpread({}, data, {
        timestamp: timestamp
      })).substr(1)).finalize().toString();
